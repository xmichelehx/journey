...
$bannerNum = "2"; //can change this (available:  1, 2, 3 or 4) - also add 'selected' class to appropriate navigation bullet in html lines 97-103
...
<div class="tp-bullets simplebullets round">
    ...
    <a class="bullet selected" href="index2.php">
    </a>
