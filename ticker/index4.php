...
$bannerNum = "4"; //can change this (available:  1, 2, 3 or 4) - also add 'selected' class to appropriate navigation bullet in html lines 97-103
...
<div class="tp-bullets simplebullets round">
	...
	<a class="bullet first" href="index1.php" >
    </a>
    <a class="bullet" href="index2.php">
    </a>
    <a class="bullet" href="index3.php">
    </a>
    <a class="bullet last selected" href="index4.php">
    </a>
